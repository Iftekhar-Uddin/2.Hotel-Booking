  ...
  return (
    <div className="header">
      <div className={type === "list"? "headerContainer ListMode" : "headerContainer"}>
        ...
        <p className="headerDesc">Get rewarded for your travels - unlock instant savings of 10% or more with a free EpuBooking account</p>
        {!user && <button className="titleBtn">Sign In / Register</button>}
